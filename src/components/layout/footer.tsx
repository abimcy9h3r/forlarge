        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link href="/careers" className="hover:text-sky-500 transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link href="/roadmap" className="hover:text-sky-500 transition-colors">
                  Roadmap
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link href="/support" className="hover:text-sky-500 transition-colors">
                  Support
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/api" className="hover:text-sky-500 transition-colors">
                  API
                </Link>
              </li>
            </ul>
