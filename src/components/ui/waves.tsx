...
const Waves: React.FC<WavesProps> = ({
  ...
  // Use theme-aware default colors if lineColor not provided
  const defaultLineColor = theme === 'dark' ? 'rgb(14, 165, 233)' : 'rgb(56, 189, 248)';
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 bg-sky-500 rounded-full w-2 h-2 opacity-50"
        style={{
